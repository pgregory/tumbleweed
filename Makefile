...
default:
	...
	@cd source && $(CC) $(LDFLAGS) memory.o names.o news.o interp.o primitive.o filein.o lex.o parser.o unixio.o st.o sysprimitive.o ffiprimitive.o -o ../st $(LIBS)
	@cd source && $(CC) $(LDFLAGS) memory.o names.o news.o interp.o primitive.o filein.o lex.o parser.o unixio.o initial.o sysprimitive.o ffiprimitive.o -o ../initial $(LIBS)
